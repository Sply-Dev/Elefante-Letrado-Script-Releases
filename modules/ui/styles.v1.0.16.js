/**
 * Elefante Letrado Script - UI Styles & Animations v1.0.16
 */
  ...
  window.ElefanteUIStyles = {
    inject() {
      ...
      estiloAnimacoes.textContent = `
        ...
        /* Base do Painel e Cabeçalho com aceleração GPU (Will-change refinado sem scale reflow) */
        #ea-panel {
          ...
          will-change: left, top, padding, background, border-radius;
        ...
        /* Modo Arraste: Sem scale (evita reflow de fonte) e com sombra leve de 0.40 opacidade */
        #ea-panel.ea-dragging {
          transform: none !important;
          box-shadow: 0 14px 35px rgba(0, 0, 0, 0.40) !important;
