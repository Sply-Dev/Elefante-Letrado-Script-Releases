/**
 * Elefante Letrado Script - UI Styles & Animations v1.0.17
 */
  ...
  window.ElefanteUIStyles = {
    inject() {
      ...
      estiloAnimacoes.textContent = `
        ...
        /* Base do Painel com transição aveludada de 0.35s para box-shadow */
        #ea-panel {
          position: fixed; top: 20px; right: 20px; z-index: 999999;
          background: #1e1e2e; color: #cdd6f4; font-family: monospace;
          border: 1px solid #313244; border-radius: 16px; padding: 20px;
          box-shadow: 0 12px 40px rgba(0,0,0,0.60); width: 380px;
          max-width: calc(100vw - 40px); display: flex; flex-direction: column;
          will-change: left, top, padding, background, border-radius, box-shadow;
        ...
        /* Modo Arraste: Transição de sombra super macia (0.35s cubic-bezier) ao pegar e soltar */
