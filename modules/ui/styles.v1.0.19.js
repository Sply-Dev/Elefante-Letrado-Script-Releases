/**
 * Elefante Letrado Script - UI Styles & Animations v1.0.19
 */
  ...
  window.ElefanteUIStyles = {
    inject() {
      ...
      estiloAnimacoes.textContent = `
        ...
        /* Base do Painel com sombra normal discreta */
        #ea-panel {
        ...
        /* Estrutura do painel e animação de minimização (Sem scale(0.97) para zerar a puladinha horizontal) */
        .ea-panel-content {
          overflow: hidden;
