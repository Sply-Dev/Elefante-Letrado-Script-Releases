/**
 * Elefante Letrado Script - UI Styles & Animations v1.0.27
 * v1.0.27: Corrigido will-change sobrecarregado no #ea-panel e elementos
 *          derivados, que forçava o navegador a manter layers de composição
 *          GPU vivas para propriedades caras (background, box-shadow,
 *          border-radius, max-height, margin, padding). Isso aparecia no
 *          profiler como ~44% do tempo de frame gasto em "Paint 3D",
 *          responsável pela travadinha após alguns segundos na página.
 *          will-change agora lista só "transform", a única propriedade
 *          usada aqui que realmente se beneficia de composição em GPU.
 */
