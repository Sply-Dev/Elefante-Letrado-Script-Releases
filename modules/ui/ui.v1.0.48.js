/**
 * Elefante Letrado Script - Módulo UI v1.0.48
  ...
  const UIModule = {
    ...
    updateAutoButton(active) {
      ...
      if (autoBtn) {
        ...
        if (active) {
          ...
          autoBtn.innerHTML = hasKey ? `${i.svgPlay} Iniciar` : `${i.svgPlay} Iniciar Auto-Página`;
    ...
    renderMainScreen() {
      ...
      const buttonText = isRunning
        ? '⏹ Parar'
        : (apiKey ? `${i.svgPlay} Iniciar` : `${i.svgPlay} Iniciar Auto-Página`);
      ...
      this.renderContent(`
        ...
        <button id="ea-reset-btn" class="ea-btn-animado" style="
          ...
          display:flex;align-items:center;justify-content:center;gap:8px;
        ">${i.svgReconfigurar} Reconfigurar</button>
      `);
