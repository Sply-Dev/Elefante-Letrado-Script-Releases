/**
 * Elefante Letrado Script - Módulo UI v1.0.14
...
(function () {
  ...
  const UIModule = {
    ...
    createPanelShell() {
        ...
        panel.innerHTML = `
          <div id="ea-drag-header">
            ...
            <div style="display: flex; align-items: center; gap: 12px;">
              <button id="ea-min-btn" class="ea-btn-icone" style="width: 24px; height: 24px; border: none; border-radius: 6px; background: #313244; color: #cdd6f4; cursor: pointer; font-size: 14px; font-weight: bold; display: inline-flex; align-items: center; justify-content: center; flex-shrink: 0; text-align: center; transition: transform 0.35s cubic-bezier(0.16, 1, 0.3, 1) !important;">−</button>
            </div>
          </div>
      ...
      // Lógica de Minimização (Com animação fluida no cabeçalho e no container)
