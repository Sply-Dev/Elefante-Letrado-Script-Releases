/**
 * Elefante Letrado Script - Módulo UI v1.0.53
    ...
    renderConfigScreen() {
      ...
      this.renderContent(`
        <div style="display:flex;flex-direction:column;align-items:center;">
          ...
          <button id="ea-model-save" class="ea-btn-animado" style="width:100%;padding:11px;border:none;border-radius:10px;background:#a6e3a1;color:#1e1e2e;font-weight:700;font-size:14px;cursor:pointer;margin-top:6px;margin-bottom:0px;display:flex;align-items:center;justify-content:center;gap:8px;">${salvarIcon} Salvar</button>
          <button id="ea-model-back" class="ea-btn-animado" style="width:100%;padding:10px;border:none;border-radius:10px;background:#45475a;color:#cdd6f4;font-size:13px;cursor:pointer;margin-top:-2px;display:flex;align-items:center;justify-content:center;gap:8px;">${voltarIcon} Voltar</button>
        </div>
      `);
