/**
 * Elefante Letrado Script - UI Styles & Animations v1.0.12
 */
  ...
  window.ElefanteUIStyles = {
    inject() {
      ...
      estiloAnimacoes.textContent = `
        ...
        .ea-btn-icone {
          transition: background-color .2s ease, color .2s ease, filter .2s ease, transform 0.45s cubic-bezier(0.16, 1, 0.3, 1) !important;
        }
        ...
        /* Dropdown customizado animado (Sem translateY, hover cinza transparente em todos, slide apenas nos não-selecionados) */
        .ea-select-container {
          position: relative;
          width: 100%;
          margin-top: 14px;
        ...
        /* Hover para opções NÃO selecionadas (desliza 18px + fundo cinza transparente) */
        ...
        /* Hover na opção selecionada (fundo cinza transparente MAS sem deslizar) */
        ...
        /* Base do Painel e Cabeçalho com aceleração GPU (Transição ultra aveludada de 0.45s) */
        #ea-panel {
          ...
          will-change: transform, padding, background, border-radius;
        ...
        #ea-drag-header {
          ...
          will-change: margin, padding, background;
          transition: background 0.45s cubic-bezier(0.16, 1, 0.3, 1),
                      padding 0.45s cubic-bezier(0.16, 1, 0.3, 1),
        ...
        /* Título com animação sub-pixel ultra aveludada */
