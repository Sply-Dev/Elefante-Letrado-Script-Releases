/**
 * Elefante Letrado Script - UI Styles & Animations v1.0.25
 */
  ...
  window.ElefanteUIStyles = {
    inject() {
      ...
      estiloAnimacoes.textContent = `
        ...
        /* Animação de Hover e Focus nos inputs do intervalo de auto-página */
        ...
        #ea-min-input:focus, #ea-max-input:focus {
          border-color: #af74f0 !important;
          box-shadow: 0 0 8px rgba(175, 116, 240, 0.25) !important;
        }
