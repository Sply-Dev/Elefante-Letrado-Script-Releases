/**
 * Elefante Letrado Script - UI Styles & Animations v1.0.20
 */
  ...
  window.ElefanteUIStyles = {
    inject() {
      ...
      estiloAnimacoes.textContent = `
        ...
        /* Estrutura Base do Painel (Sem pulos de padding, 100% constante) */
        #ea-panel {
        ...
        /* Cabeçalho do Painel com arredondamento animado nos cantos inferiores */
        #ea-drag-header {
        ...
        /* Corpo do Painel: Animação sincronizada de max-height + padding para zero puladinha */
        .ea-panel-content {
          overflow: hidden;
          background: #1e1e2e;
