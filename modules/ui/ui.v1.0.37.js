/**
 * Elefante Letrado Script - Módulo UI v1.0.37
    ...
    renderMainScreen() {
      ...
      this.renderContent(`
        ...
        <button id="ea-auto-btn" class="ea-btn-animado" style="
          ...
          font-size:14px;cursor:pointer;color:#1e1e2e; transform:translateY(3px);
        ">${buttonText}</button>
        ...
        <button id="ea-reset-btn" class="ea-btn-animado" style="
          ...
          border-radius:10px;background:#45475a; font-size:13px;cursor:pointer;color:#cdd6f4; transform:translateY(-2px);
        ">⚙ Reconfigurar</button>
      `);
    ...
    renderConfigScreen() {
      ...
      this.renderContent(`
        <div style="display:flex;flex-direction:column;align-items:center;">
          ...
          <!-- Dropdown Customizado Animado Refinado -->
          ...
          <button id="ea-model-save" class="ea-btn-animado" style="width:100%;padding:11px;border:none;border-radius:10px;background:#a6e3a1;color:#1e1e2e;font-weight:700;font-size:14px;cursor:pointer;margin-bottom:-1px;">💾 Salvar</button>
