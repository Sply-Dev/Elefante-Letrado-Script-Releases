/**
 * Elefante Letrado Script - UI Styles & Animations v1.0.21
 */
  ...
  window.ElefanteUIStyles = {
    inject() {
      ...
      estiloAnimacoes.textContent = `
        ...
        /* Base do Painel com sombra normal discreta (rgba 0.35) */
        #ea-panel {
        ...
        /* Estrutura do painel e animação de minimização (Sem scale(0.97) para zerar o estufamento horizontal) */
        .ea-panel-content {
          overflow: visible;
